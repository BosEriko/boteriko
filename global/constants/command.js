...
const commandConstant = [
  ...
  { command: 'bookmark', parameter: true, availability: [TWITCH], restricted: true, description: 'Bookmark the current moment in the stream for highlights or review later.' },
