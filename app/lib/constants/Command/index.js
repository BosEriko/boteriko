...
const Command = [
  ...
  { command: 'pomodoro', parameter: true, availability: [TWITCH], restricted: true, streaming: false, description: 'Set pomodoro sessions for focused work and break intervals.' },
  { command: 'queue', parameter: false, availability: [TWITCH], restricted: false, streaming: false, description: 'Show a link to the queue.' },
  ...
  { command: 'todo', parameter: true, availability: [TWITCH], restricted: true, streaming: false, description: 'Set tasks when working.' },
